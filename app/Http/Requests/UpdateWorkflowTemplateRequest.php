...
/**
 * Handles UpdateWorkflowTemplateRequest responsibilities for the ApproveHub domain.
 */
class UpdateWorkflowTemplateRequest extends FormRequest
{
    ...
    {
        $organization = $this->route('organization');
        $workflowTemplate = $this->route('workflowTemplate');
        $organizationId = $organization instanceof Organization ? $organization->id : 0;
        $workflowTemplateId = $workflowTemplate instanceof WorkflowTemplate ? $workflowTemplate->id : 0;
